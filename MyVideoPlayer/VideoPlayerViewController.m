...
- (void)loadView {
    ...
    CGFloat widthOfVideo = 290;
    CGFloat heightOfVideo = widthOfVideo * 70/100;
    [playerView setFrame:CGRectMake((window.size.width - widthOfVideo)/2, (250 - heightOfVideo)/2, widthOfVideo, heightOfVideo)];
